...
鸣谢
----------------------
本项目基于 `2021 年春季学期操作系统实验指导书 <https://rcore-os.github.io/rCore-Tutorial-Book-v3/index.html>`_ ，重构的目标是在保留结构的基础上屏蔽不必要的细节，缩短篇幅，优化语言，降低阅读成本。
...
- :doc:`/rest-example` 给出了目前编写文档采用的 ReStructuredText 标记语言的一些基础语法及用例；
